...
def train(args,
    ...
    for _ in train_iterator:    # train_iteratior : 3285개 총 iteration 수
        epoch_iterator = tqdm(train_dataloader, desc="Iteration")
        for step, batch in enumerate(epoch_iterator):   # epoch_iterator : 219개 minibatch 당 총 iteration 수
            model.train()
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0 or (
                ...
                # log 표시 결정중
                if args.logging_steps > 0 and global_step % args.logging_steps == 0:    # logging_steps : iteration 수, global_step : 진행중인 현재 iteration 수
